...
def print_item(key):
       ...
       if 'note' in tasks_dict[key]:
          ...
          note = ""
       if 'tag' in tasks_dict[key]:
          tag = tasks_dict[key]['tag']

       print(str(key) + " - " + '%5s' % tag + " - " + date_due + " - " + priority + " - " + tasks_dict[key]['status'] 
